      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 space-y-20 w-full">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-5 rounded-2xl bg-[#161918] border border-[#2A2E2C] space-y-2">
              <div className="text-[10px] font-mono uppercase text-amber-400">DATABASE & GIS</div>
              <div className="text-base font-bold text-[#F2F2F0]">PostgreSQL + PostGIS</div>
              <p className="text-xs text-[#9BA39E]">Spatial indexing Bounding-Box geo-queries, deduplication distance radius calculations, transaction safety.</p>
            </div>
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-[#161918] via-[#141816] to-[#0F1411] border border-[#2E7D32]/40 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-3 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1B5E20]/30 border border-[#2E7D32]/40 text-[#81C784] text-xs font-semibold">
              ...
              <span>Lisensi Terbuka (MIT License)</span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#F2F2F0]">
              Berkolaborasi Bersama Fixora
            </h3>
            <p className="text-sm text-[#9BA39E] max-w-xl leading-relaxed">
              Fixora adalah proyek open source untuk kepentingan masyarakat Indonesia. Siapapun dipersilakan berkontribusi baik pada backend Go, frontend React, dokumentasi, maupun dataset pengujian AI.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            <Link
              to="/lapor"
              className="w-full sm:w-auto py-3 px-6 rounded-2xl bg-[#2E7D32] hover:bg-[#1B5E20] text-white text-sm font-bold transition-all shadow-lg flex items-center justify-center gap-2 active:scale-95 cursor-pointer"
            >
            ...
            <Link
              to="/peta"
              className="w-full sm:w-auto py-3 px-6 rounded-2xl bg-[#161918] hover:bg-[#1F2422] border border-[#2A2E2C] text-[#F2F2F0] text-sm font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto py-3 px-5 rounded-2xl bg-[#0D0F0E] hover:bg-[#161918] border border-[#2A2E2C] text-[#9BA39E] hover:text-[#F2F2F0] text-sm font-medium transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
